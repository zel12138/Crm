        ...
        <div class="layui-input-block">
            <#if grade??>
                <select name="grade" readonly="readonly">
                    <option <#if grade==0> value="0" selected="selected"</#if>>一级菜单</option>
                   <option <#if grade==1> value="1" selected="selected"</#if>>二级菜单</option>
                   <option <#if grade==2> value="2" selected="selected"</#if>>三级菜单</option>
                </select>
            </#if>
        </div>
    </div>
